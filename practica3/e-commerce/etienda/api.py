...
from etienda.models import Producto, get_productos, get_producto_by_id, add_producto_api, modify_product,delete_product
...
@api.put("/productos/<id>", tags=['Productos'], response={200: ProductoSchema, 404: ErrorSchema})
